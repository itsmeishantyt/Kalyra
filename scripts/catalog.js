/**
 * KALYRA PRODUCT CATALOG
 * ----------------------
 * This file contains the registry for full product details.
 * You only need to add items here if you want to provide custom descriptions
 * or multiple images for the Product Detail Page.
 * 
 * For simple products, you can just add them to shop.html and the system 
...
window.CATALOG = [
    ...
    {
        id: 'butterfly-mirror',
        name: 'Ethereal Butterfly Mirror Art',
        category: 'mandala',
        price: 4299,
        style: 'Spiritual Mandala',
    ...
    {
        id: 'golden-coasters',
        name: 'Golden Shore Resin Coasters',
        category: 'living',
        price: 1299,
        style: 'Calm & Minimal',
    ...
    {
        id: 'wedding-plate',
        name: 'Eternal Vows Wedding Plate',
        category: 'bespoke',
        price: 3899,
        style: 'Spiritual Mandala',
